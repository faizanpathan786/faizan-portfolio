...
const ABOUT_TEXT =
  "I'm a Full Stack Developer who transforms ideas into scalable, high-performance web applications. I work end-to-end across Vue.js, React, Node.js, Express, Prisma and PostgreSQL, with a strong focus on clean architecture and intuitive user experiences. Certified in Generative AI for Web Development and currently completing my MCA, I'm driven to build products that create real impact. Let's create something exceptional together.";
