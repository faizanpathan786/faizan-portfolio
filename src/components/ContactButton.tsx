...
export const CONTACT_EMAIL = 'faizan514pathan@gmail.com';
// Buttons now scroll to the contact form section instead of opening a mail client.
export const CONTACT_MAILTO = '#contact';
